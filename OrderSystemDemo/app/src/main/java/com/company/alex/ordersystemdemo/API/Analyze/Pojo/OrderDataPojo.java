package com.company.alex.ordersystemdemo.API.Analyze.Pojo;
...
public class OrderDataPojo implements Serializable {
    ...
    public String getS_complete_time() {
        return s_complete_time;
    }

    public void setS_complete_time(String s_complete_time) {
        this.s_complete_time = s_complete_time;
    }
