...
import com.example.alex.designateddriving_driver.RecyclerAdapter.DepositRecordRecyclerAdapter;
...
public class Fragment_myDeposit extends Fragment {
    private View v;
    private DepositRecordRecyclerAdapter depositRecordRecyclerAdapter;
    ...
    private void initRecylcerView() {
        ...
        depositRecordRecyclerAdapter = new DepositRecordRecyclerAdapter(getContext());
        recyclerView.setAdapter(depositRecordRecyclerAdapter);
    }
