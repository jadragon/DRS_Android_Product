...
public class ContactJsonData {
    private static final String getContact_url = "http://api.gok1945.com/main/mcenter/contact/getContact.php";
    private static final String getContactCont_url = "http://api.gok1945.com/main/mcenter/contact/getContactCont.php";
    private static final String setContact_url = "http://api.gok1945.com/main/mcenter/contact/setContact.php";
    private static final String delContact_url = "http://api.gok1945.com/main/mcenter/contact/delContact.php";
    private static final String setContactCont_url = "http://api.gok1945.com/main/mcenter/contact/setContactCont.php";
