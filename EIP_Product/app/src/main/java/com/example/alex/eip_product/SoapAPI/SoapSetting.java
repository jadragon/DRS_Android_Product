...
public class SoapSetting {
    ...
    private static final String URL = "https://scgeiptest.sunchain.com.tw/ws/wsSCG.asmx?WSDL";//訪問地址
    private static final String TAG = "SOAP";

    //送API
    static JSONObject sendAPI(SoapObject request, String SOAP_ACTION) throws IOException, XmlPullParserException, JSONException {
//            创建soap 数据
