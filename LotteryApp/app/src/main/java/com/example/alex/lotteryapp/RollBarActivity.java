...
public class RollBarActivity extends AppCompatActivity {
    ...
    private void initY() {
        intY1 = (int) (80+dm.density+((dm.heightPixels-250*dm.density) / 4));
        intY2 =(int) (80+dm.density+((dm.heightPixels-250*dm.density) / 2));
        intY3 =(int) (dm.heightPixels-250*dm.density);
    }
    ...
    private void startRoll() {
        ...
        }, randomLong(50, 100), randomLong(200, 800));
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            txt_total.setText("得獎人員:" + switcher1.getText().toString() + switcher2.getText().toString() + switcher3.getText().toString());
                        }
                    });
