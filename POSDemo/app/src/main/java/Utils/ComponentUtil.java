...
public class ComponentUtil {
    ...
    public void showMainMenu(int maxWidth,View menu,View content,boolean ok) {
        if (ok) {
            MainSlideMenuAnimation animation = new MainSlideMenuAnimation(maxWidth, menu, content, 200, MainSlideMenuAnimation.EXPAND);
            menu.startAnimation(animation);
        } else {
            MainSlideMenuAnimation animation = new MainSlideMenuAnimation(maxWidth, menu, content, 200, MainSlideMenuAnimation.COLLAPSE);
            menu.startAnimation(animation);
        }
    }
