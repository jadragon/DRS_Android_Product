...
import net.xprinter.example4wifi.Utils.XprinterCodeUtils;
...
//    }
     ...
     * @return bytes for this command
     */
    public static byte[] setJumpPosition(int range) {
            ...
            public void run() {
                try {
                    ...
                    */
                    /*
                    socketWriter.write(new String(justification_left(), "UTF-8"));
                    socketWriter.write(new String(setJumpPosition(50), "UTF-8"));
                    socketWriter.write("品名:綠藻錠\n");
                    socketWriter.write("編號:27-1003\n");
                    socketWriter.write(new String(justification_center(), "UTF-8"));
                    socketWriter.write("Q-153397395-00000-8\n");
                    socketWriter.write(new String(set_bar_code_width(2), "UTF-8"));
                    socketWriter.write(new String(barcode_height((byte) 80), "UTF-8"));
                    socketWriter.write(new String(print_bar_code(BarCode.CODE39, "857945689787"), "UTF-8"));
                    */
                    socketWriter.write(XprinterCodeUtils.printBarCode(BarCode.CODE39,"123456789101"));
                    // socketWriter.write("\n");
                    socketWriter.write("123456789101");
