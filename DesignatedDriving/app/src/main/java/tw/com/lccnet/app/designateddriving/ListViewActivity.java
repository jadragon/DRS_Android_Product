    ...
    private void initlistView1() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        startActivity(new Intent(ListViewActivity.this, PersonalActivity.class));
                        break;
                    case 1:
                        startActivity(new Intent(ListViewActivity.this, CommonLocationActivity.class));
                        break;
                    case 2:
                        startActivity(new Intent(ListViewActivity.this, ChangePasswordActivity.class));
                        break;
                }
            }
        });
