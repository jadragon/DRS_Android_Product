...
public class AutoHorizontalTextView extends AppCompatTextView {
    private Paint mTextPaint;
    private float mMaxTextSize; // 获取当前所设置文字大小作为最大文字大小
    private float mMinTextSize = 3;

    public AutoHorizontalTextView(Context context) {
        this(context, null);
    }

    public AutoHorizontalTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
